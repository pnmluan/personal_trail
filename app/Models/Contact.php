...
class Contact extends BaseModel
{
    ...
    protected $fillable = ['title', 'first_name', 'last_name', 'fullname', 'phone', 'email', 'content'];
    ...
    public static function listItems(array $param = null){
        ...
        $aColumns = ['title', 'first_name', 'last_name', 'fullname', 'phone', 'email', 'content'];

        $query = \DB::table('contacts')
            ->select(\DB::raw('SQL_CALC_FOUND_ROWS id'),\DB::raw('id AS DT_RowId'),'contacts.*');
